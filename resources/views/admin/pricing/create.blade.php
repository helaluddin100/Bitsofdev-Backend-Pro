                        ...
                        <form action="{{ route('admin.pricing.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="slug" value="{{ old('slug') }}" placeholder="auto-generated">
                                    ...
                                    <div class="mb-3">
                                        <label for="description" class="form-label">Plan Description <span
                                                class="text-danger">*</span></label>
                                        <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description"
                                            rows="3" placeholder="Brief description of what this plan offers" required>{{ old('description') }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('billing_cycle') is-invalid @enderror"
                                                    ...
                                                    <option value="one-time"
                                                        {{ old('billing_cycle') == 'one-time' ? 'selected' : '' }}>One Time
                                                    </option>
                                                </select>
                                                @error('billing_cycle')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number"
                                                        ...
                                                        value="{{ old('original_price') }}" placeholder="0.00"
                                                        step="0.01" min="0">
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('currency') is-invalid @enderror"
                                                    ...
                                                    <option value="CAD"
                                                        {{ old('currency') == 'CAD' ? 'selected' : '' }}>CAD (C$)</option>
                                                    <option value="AUD"
                                                        {{ old('currency') == 'AUD' ? 'selected' : '' }}>AUD (A$)</option>
                                                </select>
                                                @error('currency')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center mt-3" id="no-features-message">
                                        <p class="text-muted">No features added yet. Click "Add Feature" to get started.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="max_projects" id="max_projects"
                                                    value="{{ old('max_projects') }}" placeholder="Unlimited"
                                                    min="1">
                                                <div class="form-text">Leave empty for unlimited</div>
                                                @error('max_projects')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="storage_limit" id="storage_limit"
                                                    value="{{ old('storage_limit') }}" placeholder="Unlimited"
                                                    min="1" step="0.1">
                                                <div class="form-text">Leave empty for unlimited</div>
                                                @error('storage_limit')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    <h6 class="mb-0"><i data-feather="search" class="me-2"></i>SEO & Meta Information
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('meta_description') is-invalid @enderror" name="meta_description"
                                            id="meta_description" rows="3" placeholder="SEO description for search engines">{{ old('meta_description') }}</textarea>
...
@section('js')
        ...
        function updatePreview() {
            ...
            features.forEach((feature, index) => {
                ...
                if (status === 'included') {
                    ...
                    featuresHtml +=
                        `<li><i data-feather="minus" class="me-2 text-warning"></i>${name} (Limited)</li>`;
                } else {
    ...
    `;
        ...
        function showToast(message, type = 'info') {
            ...
            toast.className =
                `toast align-items-center text-white bg-${type === 'error' ? 'danger' : type === 'success' ? 'success' : type === 'warning' ? 'warning' : 'info'} border-0`;
