                        ...
                        <form action="{{ route('admin.blogs.update', $blog->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input id="title" class="form-control @error('title') is-invalid @enderror"
                                    name="title" type="text" value="{{ old('title', $blog->title) }}" required>
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('excerpt') is-invalid @enderror" name="excerpt" id="excerpt" rows="3"
                            ...
                            <div class="mb-3">
                                ...
                                <small class="form-text text-muted">Image will be automatically converted to WebP format and
                                    optimized for web.</small>
                            </div>
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    ...
                                    <input type="checkbox" class="form-check-input" name="is_featured" id="is_featured"
                                        value="1" {{ $blog->is_featured ? 'checked' : '' }}>
                                </div>
                            </div>

                            <div class="mb-3">
                                <label for="meta_title" class="form-label">Meta Title</label>
                                <input id="meta_title" class="form-control @error('meta_title') is-invalid @enderror"
                                    name="meta_title" type="text" value="{{ old('meta_title', $blog->meta_title) }}">
                                @error('meta_title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('meta_description') is-invalid @enderror" name="meta_description"
                                    id="meta_description" rows="3">{{ old('meta_description', $blog->meta_description) }}</textarea>
                                <small class="form-text text-muted">Keep it between 150-160 characters for optimal
                                    SEO.</small>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="progress">
                                                    <div id="seo-score-bar" class="progress-bar" role="progressbar"
                                                        style="width: 0%">0%</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <span>Title: <span
                                                            id="title-count">{{ strlen($blog->title) }}</span>/60</span>
                                                    <span>Description: <span
                                                            id="desc-count">{{ strlen($blog->meta_description ?? '') }}</span>/160</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
