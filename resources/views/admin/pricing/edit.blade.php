                    ...
                    <form action="{{ route('admin.pricing.update', $pricing) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror"
                                      name="description" id="description" rows="3" required>{{ old('description', $pricing->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('billing_cycle') is-invalid @enderror"
                                        ...
                                        <option value="monthly" {{ old('billing_cycle', $pricing->billing_cycle) == 'monthly' ? 'selected' : '' }}>Monthly</option>
                                        <option value="quarterly" {{ old('billing_cycle', $pricing->billing_cycle) == 'quarterly' ? 'selected' : '' }}>Quarterly</option>
                                        <option value="yearly" {{ old('billing_cycle', $pricing->billing_cycle) == 'yearly' ? 'selected' : '' }}>Yearly</option>
                                        <option value="one-time" {{ old('billing_cycle', $pricing->billing_cycle) == 'one-time' ? 'selected' : '' }}>One Time</option>
                                    </select>
                                    @error('billing_cycle')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control"
                                           ...
                                           value="{{ old('original_price', $pricing->original_price) }}"
                                           step="0.01" min="0" placeholder="For discounts">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control"
                                           name="trial_days" id="trial_days"
                                           value="{{ old('trial_days', $pricing->trial_days) }}"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control"
                                           name="order" id="order"
                                           value="{{ old('order', $pricing->order) }}"
                                           min="0" placeholder="Lower = First">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" name="is_featured"
                                               id="is_featured" value="1" {{ old('is_featured', $pricing->is_featured) ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" name="is_popular"
                                               id="is_popular" value="1" {{ old('is_popular', $pricing->is_popular ?? false) ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" name="is_active"
                                               id="is_active" value="1" {{ old('is_active', $pricing->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                ...
                                <button type="submit" class="btn btn-primary" onclick="return validateForm()">Update Plan</button>
                            </div>
                        </div>
                    </form>
                </div>
